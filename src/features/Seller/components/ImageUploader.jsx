            ...
            <div className="max-w-md mx-auto rounded-lg overflow- border-2 md:max-w-xl">
                <div className="md:flex">
                    <div className="w-full ">
                        <div className="relative z-0  h-48 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">

                            <div className="absolute">

                                {image ?
                                    <img src={image} className='h-48 w-full  p-3' alt="" />
