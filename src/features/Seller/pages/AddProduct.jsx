        ...
        <>
            <div>
                ...
                <div className='px-10  flex justify-between' >
                    <div className='w-[44%] border py-5'  >
                    ...
                    <div className='w-[55%] border px-5 py-5' >
                        <form className='flex flex-col gap-5 pb-10 max-h-screen overflow-y-scroll' >
                            <div>
                            ...
                            <div className='' >
                                ...
                                <select id='Color' className='w-full border rounded-lg px-1 py-2  focus:outline-cyan-700' >
                            ...
                            <div>
                                ...
                                <input type='text' id='dimantion' placeholder='Dimantion' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                            </div>
                            ...
                            <div className='flex justify-between' >
                                ...
                                <div className='w-[45%]' >
                                    ...
                                    <input type='text' id='type' placeholder='Product Type' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>
                                <div className='w-[45%]'>
                                    <label htmlFor='design' className='font-medium px-1 py-2 flex' >Product Design </label>
                                    <input type='text' id='design' placeholder='Product Design' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>
                            </div>
                            <div className='flex justify-between' >
                                ...
                                <div className='w-[45%]' >
                                    ...
                                    <input type='text' id='Warr' placeholder='Product Warranty' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>
                                <div className='w-[45%]'>
                                    <label htmlFor='model' className='font-medium px-1 py-2 flex' >Product Modal</label>
                                    <input type='text' id='model' placeholder='Product Modal' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>
                            </div>

                            <div className='flex justify-between' >
                                <div className='w-[45%]' >
                                    <label htmlFor='style' className='font-medium px-1 py-2 flex' >Product Style</label>
                                    <input type='text' id='style' placeholder='Product Style' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>

                                <div className='w-[45%]'>
                                    <label htmlFor='Stock' className='font-medium px-1 py-2 flex' >Product IN Stock</label>
                                    <input type='text' id='Stock' placeholder='Product IN STock' className='w-full py-1 px-3 text-lg rounded-lg border focus:outline-cyan-700 ' />
                                </div>
                            </div>
                            ...
                            <div>
                                <button className='text-lg font-medium text-white bg-blue-600 px-5 py-2 rounded-lg hover:bg-blue-800 ' >Submit</button>
                            </div>
